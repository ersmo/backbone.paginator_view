...
var buf = [];
var locals_ = (locals || {}),dictionary = locals_.dictionary,lang = locals_.lang,numeral = locals_.numeral,collection = locals_.collection;buf.push("<div class=\"pagination pagination-small\"><span>" + (jade.escape((jade.interp = dictionary.total[lang]) == null ? '' : jade.interp)) + " " + (jade.escape((jade.interp = numeral(collection.totalRecords).format('0,0')) == null ? '' : jade.interp)) + " " + (jade.escape((jade.interp = dictionary.records[lang]) == null ? '' : jade.interp)) + ", " + (jade.escape((jade.interp = collection.totalPages) == null ? '' : jade.interp)) + " " + (jade.escape((jade.interp = dictionary.pages[lang]) == null ? '' : jade.interp)) + " &nbsp;</span>");
